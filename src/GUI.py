    ...
    try:
        ...
        for i, monitor in enumerate(monitor_slices):
            ...
            for column in monitor.columns:
                smoothed_monitor[column + '_run_avg_' + str(SMOOTHING_WINDOW)] = monitor[column].rolling(window=SMOOTHING_WINDOW).mean() # Change this to a forward looking moving average
